        ...
        <div className="relative py-16 sm:py-20 lg:py-24">
          ...
          >
            ...
            <p className="mt-6 text-lg sm:text-xl text-primary-600 max-w-2xl leading-relaxed">
              Empowering millions with financial literacy. Trusted voice in RBI guidelines,
              debt management, and financial rights.
            </p>
          ...
          <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2">
            <div className="w-64 h-64 rounded-full bg-accent-100 opacity-50" />
            <div className="absolute top-8 left-8 w-48 h-48 rounded-full bg-primary-100 opacity-50" />
          </div>
        </div>
      </Container>
