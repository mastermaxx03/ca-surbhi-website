...
export default function ContactPage() {
  ...
  const inputClasses = 'w-full px-4 py-3 border border-primary-200 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-200 text-primary-800 placeholder:text-primary-400'
